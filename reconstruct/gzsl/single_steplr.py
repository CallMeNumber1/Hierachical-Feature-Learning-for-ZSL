...
if __name__ == '__main__':
    ...
    writer = SummaryWriter('visualize/gzsl/single_steplr')
    ...
    if args.optimizer == 'sgd':
    ...
    elif args.optimizer == 'sgd_sgdr_lr':
        optimizer = torch.optim.SGD(model.parameters(), lr=args.lr,
        ...
        # sgd_steplr: 0.001 20 0.1
        # sgd_steplr2: 0.001 30 0.1
