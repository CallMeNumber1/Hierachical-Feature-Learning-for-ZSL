...
class Three_Layer_Dataset(data.Dataset):
    '''
        用于多分支的数据集，包括动物和上位类别的标签
    '''
    def __init__(self, args, examples, labels, transfrom, mid_labels, top_labels):
        # 初始化
    ...
    def __getitem__(self, index):
        ...
        mid_label = self.mid_labels[index]
        top_label = self.top_labels[index]
        return X, label, mid_label, top_label
